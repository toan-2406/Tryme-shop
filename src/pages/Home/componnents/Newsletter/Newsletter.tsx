    ...
    <section className=' lg:max-w-3xl mx-auto pt-10 lg:pt-28 pb-4'>
      ...
      <div className=' md:px-[127.5px]'>
        <div className='gap-5 flex flex-col md:flex-row'>
          <Input  className='h-[48px] md:float-left md:w-2/3' type={'email'} placeholder='Enter your email' classNameInput='rounded-[10px] w-full h-full px-4 border border-black font-semibold text-base' />
