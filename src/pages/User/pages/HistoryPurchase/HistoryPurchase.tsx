...
export default function HistoryPurchase() {
  ...
  const renderStatus = (status: number) => {
    ...
    return (
      <div className='inline rounded-md  py-1 px-2 text-center font-bold' style={{ backgroundColor: `${bgColor}` }}>
        {state}
      </div>
    )
  }
      ...
      <div className='overflow-x-auto'>
          <div className='min-w-[1000px]'>
            <div className='text-gray-500 text-md grid grid-cols-12 rounded-md bg-white py-5 px-9 capitalize shadow'>
              <div className='col-span-5 font-semibold'>Name & Image</div>
            ...
            <div className='my-3 rounded-md bg-white p-5 shadow'>
              {list?.length === 0 ? <div className='text-center text-lg font-semibold'>History Purchases is Empty</div> : list?.map((item) => {
                return (
                  <div
                    key={item._id}
                  ...
                  >
                    ...
                    <div className='col-span-7'>
                      <div className='grid grid-cols-5 items-center'>
                        ...
                        <div className='col-span-1'>
                          <span className='text-base font-semibold text-orange'>
