      ...
      <div className='container'>
        <div className='flex items-center justify-between gap-2'>
          ...
          <nav
            ...
            ref={ref}
          >
            <div className='absolute text-red-600 right-[-80px] rotate-90 top-1/2 lg:hidden uppercase font-bold'>Click OutSide to Close</div>
          ...
          <div className='flex items-center gap-[10px]'>
            ...
            <div>
              <Popover renderPopover={<form className='max-w-[300px] rounded-md bg-[#e1e0da] md:max-w-[400px] px-4 py-3' onSubmit={onSubmitSearch}>
               <div className='flex'>
               <input
                  type='text'
                  className='w-full h-10 border flex-grow mr-2 rounded-md bg-transparent px-3 py-1 text-black outline-none'
                  ...
                  <div className='relative  max-w-[300px] rounded-md bg-[#e1e0da] md:max-w-[400px]  '>
                    {purchasesInCart && purchasesInCart.length > 0 ? (
                      <div className='p-3'>
                        ...
                        <div className='mt-6 flex items-center justify-between'>
                          <div className='text-gray-500 text-xs font-medium capitalize'>
                            {`(${purchasesInCart.length})`} Add to cart
                          </div>
                          <Link
                            to={path.cart}
                      ...
                      <div className=' flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                        ...
                        <div className='mt-1 capitalize text-xl font-bold'>Cart empty</div>
                      </div>
                    )}
                  </div>
                }
